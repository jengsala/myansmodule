...
def presentation(module):
    ...
    return {
        "Presentation": "My name is {} and my type of attack is {}, here is what you will find in my inventory : {}".format(
            name, attack, inventory
        )
    }
...
def main():
    fields = {
        ...
        "attack": {"default": "melee", "choices": ["melee", "distance"], "type": "str"},
